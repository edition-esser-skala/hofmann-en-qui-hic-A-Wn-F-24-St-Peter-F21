    ...
    \score { %\articulate
      <<
        ...
        \new ChoirStaff \with { \setGroupDistance #15 #20 } <<
          ...
          \new Lyrics \with { \xE } \lyricsto Soprano \EnSopranoLyricsGerman
          ...
          \new Lyrics \with { \xE } \lyricsto Alto \EnAltoLyricsGerman
          ...
          \new Lyrics \with { \xE } \lyricsto Tenore \EnTenoreLyricsGerman
          ...
          \new Lyrics \with { \xE } \lyricsto Basso \EnBassoLyricsGerman
        >>
        \new StaffGroup <<
          \new Staff {
